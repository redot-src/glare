...
The caption sits right under the media, above the thumbnail strip. Slides shrink to make room for it, however many lines it takes, so it never covers the media. It hides while an image is zoomed in.
